    ...
    for epoch in range(args.epochs):
        ...
        for sample in train_dataloader:
            ...
            if step_sample % args.batch_size == 0:
                ...
                if args.wandb_log:
                    to_log["train_step/step"] = step_batch
                    to_log["train_step/loss"] = loss_batch
                    wandb.log(to_log)
                loss_batch.backward()
                optimizer.step()
                loss_batch = 0.0
        ...
        with torch.no_grad():
            ...
            if args.wandb_log:
                ...
                to_log["train_epoch/attr_error"] = average_attr_error
                to_log["train_epoch/struct_error"] = average_struct_error
            ...
            with torch.no_grad():
                ...
                if args.wandb_log:
                    ...
                    to_log["val_epoch/attr_error"] = average_val_attr_error
                    to_log["val_epoch/struct_error"] = average_val_struct_erro
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_folder",
                        type=str,
                        default="/user/sranieri/BORSA/Results/DOMINANT_norm/checkpoints",
                        help="Folder where to save checkpoints")

    parser.add_argument("--csv_results_folder",
                        type=str,
                        default="/user/sranieri/BORSA/Results/DOMINANT_norm/csv_results",
