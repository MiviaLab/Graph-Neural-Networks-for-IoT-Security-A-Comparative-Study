...
class Graph_dataset(Dataset):
    ...
    def get(self, idx):
        ...
        relative_graph_path = self.graph_list_file[idx]
        
        with open(os.path.join(self.dataset_path, relative_graph_path), "rb") as graph_file:
...
def normalize_attrs(nodes_features, min_values, max_values, tdg=False):
