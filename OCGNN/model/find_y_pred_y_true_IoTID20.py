...
def evaluate_IoTID20(args, model):
    ...
    center = torch.load(os.path.join(args.center_path, args.graph_type, 'center.pt')).to(args.device)
    radius = torch.load(os.path.join(args.radius_path, args.graph_type, 'radius.pt')).to(args.device)
    ...
    dest_file = os.path.join(args.result_path, args.graph_type, "OCGNN_test_preds_friedman.pkl")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--result_path",
                        type=str,
                        default="/user/sranieri/Thesis/pvalue/OCGNN/IoTID20/y_pred_true",
